...
CHOOSE_3_4e_IMAGE_BOX = [0.50,0.67,0.60,0.75]#3-4e菜单界面判断区域     
...
CHAPTER_3_CLICK_BOX = [0.15,0.47,0.20,0.54]#选择第3章
...
#队伍放置点
COMMAND_CLICK_BOX = [0.65,0.435,0.67,0.465]#指挥部
AIRPORT_CLICK_BOX = [0.315,0.485,0.335,0.51]#机场
...
PLAN_POINT1_CLICK_BOX = [0.495,0.58,0.51,0.6]#点击计划点1 
PLAN_POINT2_CLICK_BOX = [0.54,0.685,0.555,0.705]#点击计划点2
...
#判断是否是可以选择8-1n的界面
def is3_4e():
    initImage = cv2.imread(IMAGE_PATH+"_3_4e.png")
    capImage  = getImage(CHOOSE_3_4e_IMAGE_BOX)
    capImage  = cv2.cvtColor(np.asarray(capImage),cv2.COLOR_RGB2BGR)
    return imageCompare(initImage,capImage)
...
#从作战菜单进入3-4e界面
def combatMenuTo3_4e():
    logger.debug("ACTION: 前往3-4e选择界面")
