...
res = [
#    现有    目标    每日消耗
    [6303,  0.5+2000*cntBuild, 97*4+150*5+900*24/11+(42-500/26)*times],  # 人力
    [5277, 0.5+500*cntBuild, 404*4+151*5+900*24/11+(25-586/26)*times],   # 弹药
    [1486, 0.5+2000*cntBuild, 404*4+10*5+900*24/11+(10-454/26)*times],  # 口粮
    [13791, 0.5+1000*cntBuild, 97*4+50*5+300*24/11-115/26],  # 零件
    [0,   0,      0],    # 人形
    [0,   0,      0],    # 装备
    [0,   0,      0],    # 快建
    [0,   0,      0],    # 快修
