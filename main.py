...
res = [
#    现有    目标    每日消耗
    [157964, 65730/per+2000*cnt+730*cnt_mg, 0],  # 人力
    [143573, 34130/per+500*cnt+630*cnt_mg, 0],  # 弹药
    [142324, 78680/per+2000*cnt+130*cnt_mg, 0],  # 口粮
    [144054, 69730/per+1000*cnt+430*cnt_mg, 0],  # 零件
    [0,   0,      0],    # 人形
    [733,   417/per+20*cnt,      0],    # 装备
    [786,   10*cnt+cnt_mg,      0],    # 快建
    [0,   0,      0],    # 快修
    [0,   0,      0],    # 采购
]
