...
res = [
#    现有    目标    每日消耗
    [5966, 500*cntBuild, 130*4+45*5+900*24/11+(44)*times],  # 人力
    [5662, 500*cntBuild, 130*4+150*5+900*24/11+(25)*times],   # 弹药
    [15460, 500*cntBuild, 130*4+45*5+900*24/11+(10)*times],  # 口粮
    [38898, 500*cntBuild, 130*4+150*5+300*24/11],  # 零件
    [0,   0,      0],    # 人形
    [1132,   cntBuild,      0],    # 装备
    [0,   0,      0],    # 快建
    [0,   0,      0],    # 快修
