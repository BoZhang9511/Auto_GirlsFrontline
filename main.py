...
res = [
#    现有    目标    每日消耗
    [5020,  2000*cnt2, 97*4+120*5+900*24/11+42*times],  # 人力
    [8639, 500*cnt2, 404*4+92*5+900*24/11+25*times],   # 弹药
    [11582, 2000*cnt2, 404*4+60*5+900*24/11+10*times],  # 口粮
    [12980, 1000*cnt2, 97*4+152*5+300*24/11],  # 零件
    [0,   0,      0],    # 人形
    [0,   0,      0],    # 装备
    [0,   0,      0],    # 快建
    [0,   0,      0],    # 快修
