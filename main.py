...
res = [
#    现有    目标    每日消耗
    [822,  0.25+2000*cntBuild, 130*4+120*5+900*24/11+(42-500/26)*times],  # 人力
    [17652, 0.05+500*cntBuild, 130*4+92*5+900*24/11+(25-586/26)*times],   # 弹药
    [3066, 0.20+2000*cntBuild, 130*4+60*5+900*24/11+(10-454/26)*times],  # 口粮
    [9098, 0.15+1000*cntBuild, 30*4+152*5+300*24/11-115/26],  # 零件
    [0,   0,      0],    # 人形
    [0,   0,      0],    # 装备
    [0,   0,      0],    # 快建
    [0,   0,      0],    # 快修
