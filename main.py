...
res = [
#    现有    目标    每日消耗
    [18169,  300000+2000*cntBuild, 130*4+151*5+900*24/11+(42-500/26)*times],  # 人力
    [4390, 300000+500*cntBuild, 130*4+151*5+900*24/11+(25-586/26)*times],   # 弹药
    [1367, 300000+2000*cntBuild, 130*4+151*5+900*24/11+(10-454/26)*times],  # 口粮
    [13212, 300000+1000*cntBuild, 130*4+151*5+300*24/11-115/26],  # 零件
    [0,   0,      0],    # 人形
    [25,   3000+cntBuild,      0],    # 装备
    [342,   1500,      0],    # 快建
    [0,   0,      0],    # 快修
    [0,   0,      0],    # 采购
]
