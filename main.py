...
cntBuild = 120
combatHours = 0#0.85
times = combatHours*60/3.5#1.7
res = [
#    现有    目标    每日消耗
    [1539, 1400*20+600*ccnt, 400*5+45*5+(44)*times+900*24/11],  # 人力
    [5897, 300*20+600*ccnt, 400*5+250*5+(25)*times+900*24/11],   # 弹药
    [2333, 1000*20+600*ccnt, 400*5+45*5+(10)*times+900*24/11],  # 口粮
    [5150, 800*20+200*ccnt, 200*5+130*5+300*24/11],  # 零件
    [1607,   0,      0],    # 人形
    [12,   0,      0],    # 装备
    [96,   0,      0],    # 快建
    [0,   0,      0],    # 快修
...
auto_restore = [0, 1, 0, 0]  # 人力弹药口粮零件的自回，1为有自回，0没有
level = 100  # 队伍等级
sleeping =  0 # 睡觉时长（分钟）
delay =  3 # 平均延迟（分钟）
