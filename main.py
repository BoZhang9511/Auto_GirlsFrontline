...
cntBuild = 300
combatHours = 0.85
times = combatHours*60/1.7
res = [
#    现有    目标    每日消耗
    [11112, 0.5, 130*4+45*5+900*24/11+(52)*times],  # 人力
    [11566, 0.5, 130*4+150*5+900*24/11+(114)*times],   # 弹药
    [20213, 0.5, 130*4+45*5+900*24/11+(54)*times],  # 口粮
    [42630, 0.5, 130*4+150*5+300*24/11],  # 零件
    [0,   0,      0],    # 人形
    [0,   0,      0],    # 装备
    [0,   0,      0],    # 快建
    [0,   0,      0],    # 快修
